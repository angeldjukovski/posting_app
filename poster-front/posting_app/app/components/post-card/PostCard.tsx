      ...
      {isEditing ? (
        <div className="flex flex-col gap-4">
          ...
          <div className="flex-gap-2">
            <button className="btn btn-success btn-xs" onClick={handleUpdate}>
              Save
            </button>
            <button
        ...
        <>
          ...
          <div>
            <button
              ...
              className={`flex items-center gap-1 transition-colors ${post.isLiked ? "text-red-500" : "hover:text-red-400"} cursor-pointer`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1 transition-colors ${post.isReposted ? "text-green-500" : "hover:text-green-400"} cursor-pointer`}
            >
              Repost
          ...
          {post.user?.id === currentUser?.id && (
            <div className="flex gap-2 mt-2">
              <button className="btn btn-primary btn-xs" onClick={handleDelete}>
                Delete
              </button>
              <button
